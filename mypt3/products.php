...
<body style="background-image: url(pictures/mainbg.jpg);">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <?php
          if ($_SESSION['role'] == "Admin") { ?>
            <input name="price" type="number" class="form-control" id="productprice" placeholder="Product Price" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_product_price']; ?>" min="0.01" step="any" required>
          <?php }
          if ($_SESSION['role'] == "Normal Staff") { ?>
