...
<head>
  ...
  <title>Boy Apparel Co : Orders</title>
  <!-- Bootstrap -->
...
<body>
   ...
   <?php include_once 'nav_bar.php'; ?>
    ...
    <form action="orders.php" method="post" class="fom-horizontal">
      <div class="form-group">
         <label for="orderid" class="col-sm-3 control-label">Order ID</label>
          <div class="col-sm-9">
      <input name="oid" type="text" readonly class="form-control" id="orderid" placeholder="Order ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_num']; ?>"> <br>
       </div>
        </div>
      <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $sql = "SELECT * FROM tbl_orders_a181617, tbl_staffs_a181617_mypt2, tbl_customers_a181617_mypt2 WHERE ";
            $sql = $sql . "tbl_orders_a181617.fld_staff_num = tbl_staffs_a181617_mypt2.fld_staff_num and ";
            $sql = $sql . "tbl_orders_a181617.fld_customer_num = tbl_customers_a181617_mypt2.fld_customer_num";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a181617");
            $stmt->execute();
            $result = $stmt->fetchAll();
